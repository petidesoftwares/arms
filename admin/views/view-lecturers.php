            ...
            <tbody>
                <?php
                    ...
                    foreach($lecturers as $lecturer){
                        ...
                        if($s_n%2 ==0){
                            echo '<tr id = "grey-row"><td>'.$s_n.'</td><td id = "id_'.$s_n.'">'.$lecturer['id'].'</td><td id = "title_'.$lecturer['id'].'">'.$lecturer['title'].'</td><td id = "surname_'.$lecturer['id'].'" >'.$lecturer['surname'].'</td><td id = "firstname_'.$lecturer['id'].'" > '.$lecturer['firstname'].'</td><td id = "othername_'.$lecturer['id'].'">'.$othername.'</td><td id = "rank_'.$lecturer['id'].'">'.$lecturer['rank'].'</td><td id="mobile_'.$lecturer['id'].'">'.$lecturer['mobile_phone'].'</td><td><button  onclick = "getLecturerEditor('.$lecturer['id'].')">Edit Details</button></td></tr>';
                        }else{
                            echo '<tr><td>'.$s_n.'</td><td id = "id_'.$s_n.'">'.$lecturer['id'].'</td><td id = "title_'.$lecturer['id'].'">'.$lecturer['title'].'</td><td id = "surname_'.$lecturer['id'].'" >'.$lecturer['surname'].'<td id = "firstname_'.$lecturer['id'].'" > '.$lecturer['firstname'].'</td> <td id = "othername_'.$lecturer['id'].'" >'.$othername.'</td><td id = "rank_'.$lecturer['id'].'">'.$lecturer['rank'].'</td><td id="mobile_'.$lecturer['id'].'">'.$lecturer['mobile_phone'].'</td><td><button  onclick = "getLecturerEditor('.$lecturer['id'].')">Edit Details</button></td></tr>';
                        } 
                    }
                ?>
            </tbody>
